//CTRE DiffDrive_Sim Robot  flat framework, all system & command in this class
//uses: CTRE motor & encoder x2, pigeon IMU but only for sim image, no PID
...
public class Robot extends TimedRobot {
   ...
   * https://docs.wpilib.org/en/stable/docs/software/wpilib-tools /   /introduction.html#introduction-to-robot-characterization
   */
  ...
  /**
   * This function runs when the robot is first started up and should be used for any
   * initialization code.
   */
  @Override
  ...
  public void teleopPeriodic() {
    ...
    /* manually calculate Arcade Drive math. This can optionally be replaced with WPILib's DifferentialDrive class. 
    */
  ...
  public void simulationPeriodic() {
     ...
     * Motor output with positive (red) lead voltage is ccw. We observe
     * on our physical robot that this reverses wheel rotation for the
